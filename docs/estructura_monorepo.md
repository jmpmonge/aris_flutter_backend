...
Centraliza decisiones de arquitectura, contrato HTTP, plan de integración y notas de versión. No sustituye al código; describe **cómo** deben convivir Flutter y FastAPI.
